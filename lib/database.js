...
const sessionSchema = new mongoose.Schema({
    ...
    credentials: {
        // CORRECTION: Use a generic Object type to store
        // the entire Baileys creds.json object in a simple and robust way.
        type: Object,
        required: true
    },
...
// 4. Active numbers (for reconnection)
...
async function deleteSessionFromMongoDB(number) {
    try {
        ...
        // Optional: Delete other related data if the bot is completely "forgotten"
    ...
    try {
        ...
        if (config) {
            ...
            const defaultConfig = {
                ...
                AUTO_STATUS_MSG: 'Hello from Sparta!',
                AUTO_LIKE_EMOJI: ['♡', '👍', '😮', '😎']
            };
